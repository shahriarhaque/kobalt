 ...
 * @author Kevin Glass
 */
public abstract class AbstractPhysicsDemo extends BasicGame implements KeyboardSupport {


	/** The world containing the physics model */
	public World world = new World(new Vector2f(0.0f, 10.0f), 10, new QuadSpaceStrategy(20,5));
	...
	public AbstractPhysicsDemo(String title, int w, int h) {
		super(title, w, h);
		initDemo();
